...
const STAR_LABELS = { 1:'खूपच खराब 😞', 2:'खराब 😕', 3:'ठीक आहे 😐', 4:'चांगले 😊', 5:'उत्कृष्ट! 🤩' };
...
const RatingPage = () => {
  ...
  if (submitted) return (
    <div style={{ maxWidth: 400, margin: '60px auto', padding: 24, textAlign: 'center' }}>
      ...
      <p style={{ color: 'var(--color-text-muted)', marginBottom: 24 }}>तुमच्या अभिप्रायामुळे platform अधिक चांगले होते!</p>
      <button className="btn btn-primary btn-block" onClick={() => navigate('/bookings')}>माझ्या Bookings पाहा</button>
    </div>
  );
  ...
  return (
    <div style={{ maxWidth: 480, margin: '0 auto', padding: '32px 16px' }}>
      ...
      <p style={{ color: 'var(--color-text-muted)', marginBottom: 28 }}>Booking #{bookingId?.slice(-6)}</p>
      <form onSubmit={handleSubmit}>
        <div className="card card-body">
          <p style={{ fontSize: 16, fontWeight: 600, marginBottom: 20, textAlign: 'center' }}>{t('rating.howWasWork')}</p>
          ...
          <div className="form-group">
            ...
            <div style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 4 }}>{review.length}/1000</div>
          </div>
          <button type="submit" className="btn btn-primary btn-block btn-lg" disabled={loading || !score}>
